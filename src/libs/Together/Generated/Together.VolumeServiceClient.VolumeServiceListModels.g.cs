...
namespace Together
{
    public partial class VolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_VolumeServiceListModelsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_VolumeServiceListModelsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_VolumeServiceListModelsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_VolumeServiceListModelsSecurityRequirement0,
            };
        partial void PrepareVolumeServiceListModelsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref global::Together.VolumeServiceListModelsVisibility? visibility,
            ref string? organizationId,
            ref int? limit,
            ref string? after);
        partial void PrepareVolumeServiceListModelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Together.VolumeServiceListModelsVisibility? visibility,
            string? organizationId,
            int? limit,
            string? after);
        partial void ProcessVolumeServiceListModelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVolumeServiceListModelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeListModelsResponse> VolumeServiceListModelsAsync(
            string projectId,
        ...
        {
            var __response = await VolumeServiceListModelsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeListModelsResponse>> VolumeServiceListModelsAsResponseAsync(
            string projectId,
            global::Together.VolumeServiceListModelsVisibility? visibility = default,
            string? organizationId = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVolumeServiceListModelsArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VolumeServiceListModelsSecurityRequirements,
                operationName: "VolumeServiceListModelsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_VolumeServiceListModelsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVolumeServiceListModelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VolumeServiceListModels",
                                methodName: "VolumeServiceListModelsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVolumeServiceListModelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVolumeServiceListModelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeListModelsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeListModelsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeListModelsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
