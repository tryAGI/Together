...
namespace Together
{
    public partial class RolloutServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RolloutServicePromoteRolloutServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RolloutServicePromoteRolloutSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RolloutServicePromoteRolloutSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RolloutServicePromoteRolloutSecurityRequirement0,
            };
        partial void PrepareRolloutServicePromoteRolloutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string id,
            global::Together.DePromoteRolloutRequest request);
        partial void PrepareRolloutServicePromoteRolloutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string id,
            global::Together.DePromoteRolloutRequest request);
        partial void ProcessRolloutServicePromoteRolloutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRolloutServicePromoteRolloutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServicePromoteRolloutAsync(
            string projectId,
            string endpointId,
            string id,
        ...
        {
            var __response = await RolloutServicePromoteRolloutAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRollout>> RolloutServicePromoteRolloutAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRolloutServicePromoteRolloutArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RolloutServicePromoteRolloutSecurityRequirements,
                operationName: "RolloutServicePromoteRolloutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/promote",
                                baseUri: ResolveBaseUri(
                                servers: s_RolloutServicePromoteRolloutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRolloutServicePromoteRolloutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RolloutServicePromoteRollout",
                                methodName: "RolloutServicePromoteRolloutAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/promote\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRolloutServicePromoteRolloutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRolloutServicePromoteRolloutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeRollout.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeRollout>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeRollout.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServicePromoteRolloutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DePromoteRolloutRequest
            {
                Etag = etag,
            };

            return await RolloutServicePromoteRolloutAsync(
                projectId: projectId,
                endpointId: endpointId,
                id: id,
                request: __request,
