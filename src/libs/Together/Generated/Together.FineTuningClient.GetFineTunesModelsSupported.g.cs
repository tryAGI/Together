...
namespace Together
{
    public partial class FineTuningClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetFineTunesModelsSupportedServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetFineTunesModelsSupportedSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetFineTunesModelsSupportedSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetFineTunesModelsSupportedSecurityRequirement0,
            };
        partial void PrepareGetFineTunesModelsSupportedArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetFineTunesModelsSupportedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetFineTunesModelsSupportedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFineTunesModelsSupportedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetFineTunesModelsSupportedAsResponseAsync(
        ...
        ///      -H "Authorization: Bearer $TOGETHER_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.GetFineTunesModelsSupportedResponse>> GetFineTunesModelsSupportedAsResponseAsync(
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFineTunesModelsSupportedArguments(
                httpClient: HttpClient);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetFineTunesModelsSupportedSecurityRequirements,
                operationName: "GetFineTunesModelsSupportedAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_GetFineTunesModelsSupportedServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFineTunesModelsSupportedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getFineTunesModelsSupported",
                                methodName: "GetFineTunesModelsSupportedAsync",
                                pathTemplate: "\"/fine-tunes/models/supported\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFineTunesModelsSupportedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFineTunesModelsSupportedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.GetFineTunesModelsSupportedResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.GetFineTunesModelsSupportedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.GetFineTunesModelsSupportedResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
