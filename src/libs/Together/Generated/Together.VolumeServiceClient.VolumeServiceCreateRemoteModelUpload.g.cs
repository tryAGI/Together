...
namespace Together
{
    public partial class VolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_VolumeServiceCreateRemoteModelUploadServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_VolumeServiceCreateRemoteModelUploadSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_VolumeServiceCreateRemoteModelUploadSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_VolumeServiceCreateRemoteModelUploadSecurityRequirement0,
            };
        partial void PrepareVolumeServiceCreateRemoteModelUploadArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Together.DeCreateRemoteUploadSpec request);
        partial void PrepareVolumeServiceCreateRemoteModelUploadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Together.DeCreateRemoteUploadSpec request);
        partial void ProcessVolumeServiceCreateRemoteModelUploadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVolumeServiceCreateRemoteModelUploadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRemoteUpload> VolumeServiceCreateRemoteModelUploadAsync(
            string projectId,
        ...
        {
            var __response = await VolumeServiceCreateRemoteModelUploadAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRemoteUpload>> VolumeServiceCreateRemoteModelUploadAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVolumeServiceCreateRemoteModelUploadArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VolumeServiceCreateRemoteModelUploadSecurityRequirements,
                operationName: "VolumeServiceCreateRemoteModelUploadAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_VolumeServiceCreateRemoteModelUploadServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVolumeServiceCreateRemoteModelUploadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VolumeServiceCreateRemoteModelUpload",
                                methodName: "VolumeServiceCreateRemoteModelUploadAsync",
                                pathTemplate: "$\"/projects/{projectId}/models/uploads\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVolumeServiceCreateRemoteModelUploadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVolumeServiceCreateRemoteModelUploadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeRemoteUpload.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeRemoteUpload>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeRemoteUpload.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRemoteUpload> VolumeServiceCreateRemoteModelUploadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeCreateRemoteUploadSpec
            {
                ModelId = modelId,
                RemoteUrl = remoteUrl,
                Token = token,
            ...
            return await VolumeServiceCreateRemoteModelUploadAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
