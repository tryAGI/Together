...
namespace Together
{
    public partial class RolloutServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RolloutServiceStartRolloutServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RolloutServiceStartRolloutSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RolloutServiceStartRolloutSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RolloutServiceStartRolloutSecurityRequirement0,
            };
        partial void PrepareRolloutServiceStartRolloutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string id);
        partial void PrepareRolloutServiceStartRolloutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string endpointId,
            string id);
        partial void ProcessRolloutServiceStartRolloutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRolloutServiceStartRolloutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServiceStartRolloutAsync(
            string projectId,
            string endpointId,
            string id,
        ...
        {
            var __response = await RolloutServiceStartRolloutAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRollout>> RolloutServiceStartRolloutAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRolloutServiceStartRolloutArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RolloutServiceStartRolloutSecurityRequirements,
                operationName: "RolloutServiceStartRolloutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/start",
                                baseUri: ResolveBaseUri(
                                servers: s_RolloutServiceStartRolloutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRolloutServiceStartRolloutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RolloutServiceStartRollout",
                                methodName: "RolloutServiceStartRolloutAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/start\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRolloutServiceStartRolloutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRolloutServiceStartRolloutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
