...
namespace Together
{
    public partial class EndpointsClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_AddAdapterServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_AddAdapterSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_AddAdapterSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_AddAdapterSecurityRequirement0,
            };
        partial void PrepareAddAdapterArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string endpointId,
            global::Together.AddAdapterRequest request);
        partial void PrepareAddAdapterRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string endpointId,
            global::Together.AddAdapterRequest request);
        partial void ProcessAddAdapterResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddAdapterResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AddAdapterResponse> AddAdapterAsync(
            string endpointId,
        ...
        {
            var __response = await AddAdapterAsResponseAsync(
        ...
        /// print(result.api_model_id)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.AddAdapterResponse>> AddAdapterAsResponseAsync(
            string endpointId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddAdapterSecurityRequirements,
                operationName: "AddAdapterAsync");
            ...
            try
            {
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad Request — invalid model_id format, endpoint name mismatch, LoRA not enabled, incompatible base model, or adapter already bound
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddAdapterResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.AddAdapterResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.AddAdapterResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.AddAdapterResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.AddAdapterResponse> AddAdapterAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.AddAdapterRequest
            {
                ModelId = modelId,
            };

            return await AddAdapterAsync(
                endpointId: endpointId,
                request: __request,
                requestOptions: requestOptions,
