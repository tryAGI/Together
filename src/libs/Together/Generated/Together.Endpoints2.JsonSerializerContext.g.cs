...
namespace Together
{
    ...
    public sealed partial class Endpoints2SourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static Endpoints2SourceGenerationContext Default { get; } = new(DefaultOptions);

        private Endpoints2SourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
