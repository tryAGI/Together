...
namespace Together
{
    public partial class SharedVolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_SharedVolumeServiceGetServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_SharedVolumeServiceGetSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_SharedVolumeServiceGetSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_SharedVolumeServiceGetSecurityRequirement0,
            };
        partial void PrepareSharedVolumeServiceGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string volumeId);
        partial void PrepareSharedVolumeServiceGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string volumeId);
        partial void ProcessSharedVolumeServiceGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSharedVolumeServiceGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get a shared volume by ID<br/>
        ...
        {
            var __response = await SharedVolumeServiceGetAsResponseAsync(
                volumeId: volumeId,
        ...
        /// print(volume)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.GPUClustersSharedVolume>> SharedVolumeServiceGetAsResponseAsync(
            string volumeId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSharedVolumeServiceGetArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SharedVolumeServiceGetSecurityRequirements,
                operationName: "SharedVolumeServiceGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_SharedVolumeServiceGetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSharedVolumeServiceGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SharedVolumeServiceGet",
                                methodName: "SharedVolumeServiceGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSharedVolumeServiceGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSharedVolumeServiceGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.GPUClustersSharedVolume.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.GPUClustersSharedVolume>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.GPUClustersSharedVolume.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
