...
{
    /// <inheritdoc />
    public class DePlacementJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Together.DePlacement>
    {
        /// <inheritdoc />
        public override global::Together.DePlacement Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            if (__jsonProps.Contains("inline")) __score0++;
            var __score1 = 0;
            ...
            global::Together.DePlacementVariant1? dePlacementVariant1 = default;
            global::Together.DePlacementVariant2? dePlacementVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        dePlacementVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        dePlacementVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (dePlacementVariant1 == null && dePlacementVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Together.DePlacement(
                dePlacementVariant1,
        ...
        public override void Write(
            ...
            global::Together.DePlacement value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsDePlacementVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Together.DePlacementVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Together.DePlacementVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Together.DePlacementVariant1).Name}");
