...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetWeightsSyncOperationServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetWeightsSyncOperationSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetWeightsSyncOperationSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetWeightsSyncOperationSecurityRequirement0,
            };
        partial void PrepareGetWeightsSyncOperationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string operationId);
        partial void PrepareGetWeightsSyncOperationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string operationId);
        partial void ProcessGetWeightsSyncOperationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWeightsSyncOperationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get weights-sync operation<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlWeightsSyncOperation> GetWeightsSyncOperationAsync(
            string sessionId,
            string operationId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWeightsSyncOperationAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlWeightsSyncOperation>> GetWeightsSyncOperationAsResponseAsync(
            string sessionId,
            string operationId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWeightsSyncOperationArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWeightsSyncOperationSecurityRequirements,
                operationName: "GetWeightsSyncOperationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/rl/training-sessions/{sessionId}/operations/weights-sync/{operationId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetWeightsSyncOperationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWeightsSyncOperationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetWeightsSyncOperationAsync",
                                pathTemplate: "$\"/rl/training-sessions/{sessionId}/operations/weights-sync/{operationId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWeightsSyncOperationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWeightsSyncOperationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RlWeightsSyncOperation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RlWeightsSyncOperation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RlWeightsSyncOperation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
