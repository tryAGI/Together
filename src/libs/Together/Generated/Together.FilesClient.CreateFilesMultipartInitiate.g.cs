...
namespace Together
{
    ...
    {
        partial void PrepareCreateFilesMultipartInitiateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Together.MultipartInitiateRequest request);
        partial void PrepareCreateFilesMultipartInitiateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Together.MultipartInitiateRequest request);
        partial void ProcessCreateFilesMultipartInitiateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateFilesMultipartInitiateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.MultipartInitiateResponse> CreateFilesMultipartInitiateAsync(
            global::Together.MultipartInitiateRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateFilesMultipartInitiateArguments(
            ...
            PrepareCreateFilesMultipartInitiateRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateFilesMultipartInitiateResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateFilesMultipartInitiateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Together.MultipartInitiateResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Together.MultipartInitiateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.MultipartInitiateResponse> CreateFilesMultipartInitiateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.MultipartInitiateRequest
            {
                FileSize = fileSize,
                FileType = fileType,
                Filename = filename,
            ...
            return await CreateFilesMultipartInitiateAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
