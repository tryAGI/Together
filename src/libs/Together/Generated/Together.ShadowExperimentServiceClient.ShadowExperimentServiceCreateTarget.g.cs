...
namespace Together
{
    public partial class ShadowExperimentServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_ShadowExperimentServiceCreateTargetServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_ShadowExperimentServiceCreateTargetSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_ShadowExperimentServiceCreateTargetSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_ShadowExperimentServiceCreateTargetSecurityRequirement0,
            };
        partial void PrepareShadowExperimentServiceCreateTargetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string experimentId,
            global::Together.DeCreateShadowExperimentTargetRequest request);
        partial void PrepareShadowExperimentServiceCreateTargetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string experimentId,
            global::Together.DeCreateShadowExperimentTargetRequest request);
        partial void ProcessShadowExperimentServiceCreateTargetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessShadowExperimentServiceCreateTargetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeShadowExperimentTarget> ShadowExperimentServiceCreateTargetAsync(
            string projectId,
            string endpointId,
            string experimentId,
        ...
        {
            var __response = await ShadowExperimentServiceCreateTargetAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeShadowExperimentTarget>> ShadowExperimentServiceCreateTargetAsResponseAsync(
            string projectId,
            string endpointId,
            string experimentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareShadowExperimentServiceCreateTargetArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ShadowExperimentServiceCreateTargetSecurityRequirements,
                operationName: "ShadowExperimentServiceCreateTargetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_ShadowExperimentServiceCreateTargetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareShadowExperimentServiceCreateTargetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ShadowExperimentServiceCreateTarget",
                                methodName: "ShadowExperimentServiceCreateTargetAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/shadowExperiments/{experimentId}/targets\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessShadowExperimentServiceCreateTargetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessShadowExperimentServiceCreateTargetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeShadowExperimentTarget.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeShadowExperimentTarget>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeShadowExperimentTarget.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeShadowExperimentTarget> ShadowExperimentServiceCreateTargetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeCreateShadowExperimentTargetRequest
            {
                Name = name,
            ...
            return await ShadowExperimentServiceCreateTargetAsync(
                projectId: projectId,
                endpointId: endpointId,
                experimentId: experimentId,
                request: __request,
