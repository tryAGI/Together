...
namespace Together
{
    public partial class RolloutServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RolloutServiceResumeRolloutServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RolloutServiceResumeRolloutSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RolloutServiceResumeRolloutSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RolloutServiceResumeRolloutSecurityRequirement0,
            };
        partial void PrepareRolloutServiceResumeRolloutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string id,
            global::Together.DeResumeRolloutRequest request);
        partial void PrepareRolloutServiceResumeRolloutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string id,
            global::Together.DeResumeRolloutRequest request);
        partial void ProcessRolloutServiceResumeRolloutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRolloutServiceResumeRolloutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServiceResumeRolloutAsync(
            string projectId,
            string endpointId,
            string id,
        ...
        {
            var __response = await RolloutServiceResumeRolloutAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRollout>> RolloutServiceResumeRolloutAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRolloutServiceResumeRolloutArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RolloutServiceResumeRolloutSecurityRequirements,
                operationName: "RolloutServiceResumeRolloutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_RolloutServiceResumeRolloutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRolloutServiceResumeRolloutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RolloutServiceResumeRollout",
                                methodName: "RolloutServiceResumeRolloutAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/resume\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRolloutServiceResumeRolloutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRolloutServiceResumeRolloutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServiceResumeRolloutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeResumeRolloutRequest
            {
                Etag = etag,
            };

            return await RolloutServiceResumeRolloutAsync(
                projectId: projectId,
                endpointId: endpointId,
                id: id,
                request: __request,
