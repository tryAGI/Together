...
namespace Together
{
    public partial class RemediationServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RemediationServiceRejectRemediationServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RemediationServiceRejectRemediationSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RemediationServiceRejectRemediationSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RemediationServiceRejectRemediationSecurityRequirement0,
            };
        partial void PrepareRemediationServiceRejectRemediationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId,
            ref string instanceId,
            ref string remediationId,
            global::Together.CommentBody request);
        partial void PrepareRemediationServiceRejectRemediationRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Together.CommentBody request);
        partial void ProcessRemediationServiceRejectRemediationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemediationServiceRejectRemediationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.Remediation> RemediationServiceRejectRemediationAsync(
            string clusterId,
            string instanceId,
            string remediationId,
        ...
        {
            var __response = await RemediationServiceRejectRemediationAsResponseAsync(
                clusterId: clusterId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.Remediation>> RemediationServiceRejectRemediationAsResponseAsync(
            string clusterId,
            string instanceId,
            string remediationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemediationServiceRejectRemediationArguments(
                httpClient: HttpClient,
                clusterId: ref clusterId,
                instanceId: ref instanceId,
                remediationId: ref remediationId,
                request: request);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_RemediationServiceRejectRemediationSecurityRequirements,
                operationName: "RemediationServiceRejectRemediationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/compute/clusters/{clusterId}/instances/{instanceId}/remediations/{remediationId}/reject",
                                baseUri: ResolveBaseUri(
                                servers: s_RemediationServiceRejectRemediationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemediationServiceRejectRemediationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RemediationServiceRejectRemediation",
                                methodName: "RemediationServiceRejectRemediationAsync",
                                pathTemplate: "$\"/compute/clusters/{clusterId}/instances/{instanceId}/remediations/{remediationId}/reject\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemediationServiceRejectRemediationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemediationServiceRejectRemediationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.Remediation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.Remediation>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.Remediation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await RemediationServiceRejectRemediationAsync(
                clusterId: clusterId,
                instanceId: instanceId,
                remediationId: remediationId,
                request: __request,
