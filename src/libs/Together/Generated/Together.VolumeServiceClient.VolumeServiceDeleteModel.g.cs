...
namespace Together
{
    public partial class VolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_VolumeServiceDeleteModelServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_VolumeServiceDeleteModelSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_VolumeServiceDeleteModelSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_VolumeServiceDeleteModelSecurityRequirement0,
            };
        partial void PrepareVolumeServiceDeleteModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string id);
        partial void PrepareVolumeServiceDeleteModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string id);
        partial void ProcessVolumeServiceDeleteModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVolumeServiceDeleteModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeDeleteResponse> VolumeServiceDeleteModelAsync(
            string projectId,
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await VolumeServiceDeleteModelAsResponseAsync(
                projectId: projectId,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeDeleteResponse>> VolumeServiceDeleteModelAsResponseAsync(
            string projectId,
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVolumeServiceDeleteModelArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VolumeServiceDeleteModelSecurityRequirements,
                operationName: "VolumeServiceDeleteModelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_VolumeServiceDeleteModelServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVolumeServiceDeleteModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VolumeServiceDeleteModel",
                                methodName: "VolumeServiceDeleteModelAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVolumeServiceDeleteModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVolumeServiceDeleteModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
