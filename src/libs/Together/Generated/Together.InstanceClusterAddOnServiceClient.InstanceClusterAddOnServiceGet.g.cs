...
namespace Together
{
    public partial class InstanceClusterAddOnServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_InstanceClusterAddOnServiceGetServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_InstanceClusterAddOnServiceGetSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_InstanceClusterAddOnServiceGetSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_InstanceClusterAddOnServiceGetSecurityRequirement0,
            };
        partial void PrepareInstanceClusterAddOnServiceGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId,
            ref string addonId);
        partial void PrepareInstanceClusterAddOnServiceGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string clusterId,
            string addonId);
        partial void ProcessInstanceClusterAddOnServiceGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInstanceClusterAddOnServiceGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.AddOnInfo> InstanceClusterAddOnServiceGetAsync(
            string clusterId,
            string addonId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await InstanceClusterAddOnServiceGetAsResponseAsync(
                clusterId: clusterId,
                addonId: addonId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.AddOnInfo>> InstanceClusterAddOnServiceGetAsResponseAsync(
            string clusterId,
            string addonId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInstanceClusterAddOnServiceGetArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InstanceClusterAddOnServiceGetSecurityRequirements,
                operationName: "InstanceClusterAddOnServiceGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_InstanceClusterAddOnServiceGetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInstanceClusterAddOnServiceGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InstanceClusterAddOnServiceGet",
                                methodName: "InstanceClusterAddOnServiceGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInstanceClusterAddOnServiceGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInstanceClusterAddOnServiceGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
