...
namespace Together
{
    public partial class VolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_VolumeServiceUpdateModelServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_VolumeServiceUpdateModelSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_VolumeServiceUpdateModelSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_VolumeServiceUpdateModelSecurityRequirement0,
            };
        partial void PrepareVolumeServiceUpdateModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string id,
            ref string? updateMask,
            global::Together.DeUpdateModelRequest request);
        partial void PrepareVolumeServiceUpdateModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? updateMask,
            global::Together.DeUpdateModelRequest request);
        partial void ProcessVolumeServiceUpdateModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVolumeServiceUpdateModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeModel> VolumeServiceUpdateModelAsync(
            string projectId,
            string id,
        ...
        {
            var __response = await VolumeServiceUpdateModelAsResponseAsync(
                projectId: projectId,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeModel>> VolumeServiceUpdateModelAsResponseAsync(
            string projectId,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVolumeServiceUpdateModelArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VolumeServiceUpdateModelSecurityRequirements,
                operationName: "VolumeServiceUpdateModelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_VolumeServiceUpdateModelServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVolumeServiceUpdateModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VolumeServiceUpdateModel",
                                methodName: "VolumeServiceUpdateModelAsync",
                                pathTemplate: "$\"/projects/{projectId}/models/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVolumeServiceUpdateModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVolumeServiceUpdateModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeModel> VolumeServiceUpdateModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeUpdateModelRequest
            {
                Name = name,
            ...
            return await VolumeServiceUpdateModelAsync(
                projectId: projectId,
                id: id,
                updateMask: updateMask,
                request: __request,
