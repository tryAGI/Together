...
namespace Together
{
    ...
    public sealed partial class DeploymentServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static DeploymentServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private DeploymentServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
