...
namespace Together
{
    ...
    public sealed partial class ShadowExperimentServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ShadowExperimentServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ShadowExperimentServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
