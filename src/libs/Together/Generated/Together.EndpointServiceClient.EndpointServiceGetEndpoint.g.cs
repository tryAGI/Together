...
namespace Together
{
    public partial class EndpointServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EndpointServiceGetEndpointServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EndpointServiceGetEndpointSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EndpointServiceGetEndpointSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EndpointServiceGetEndpointSecurityRequirement0,
            };
        partial void PrepareEndpointServiceGetEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string id);
        partial void PrepareEndpointServiceGetEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string id);
        partial void ProcessEndpointServiceGetEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEndpointServiceGetEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeEndpoint> EndpointServiceGetEndpointAsync(
            string projectId,
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EndpointServiceGetEndpointAsResponseAsync(
                projectId: projectId,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeEndpoint>> EndpointServiceGetEndpointAsResponseAsync(
            string projectId,
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEndpointServiceGetEndpointArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EndpointServiceGetEndpointSecurityRequirements,
                operationName: "EndpointServiceGetEndpointAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EndpointServiceGetEndpointServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEndpointServiceGetEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EndpointServiceGetEndpoint",
                                methodName: "EndpointServiceGetEndpointAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEndpointServiceGetEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEndpointServiceGetEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
