...
namespace Together
{
    public partial class FineTuningClient
    {
        ...
        {
            var __response = await GetFineTunesModelsLimitsAsResponseAsync(
                modelName: modelName,
        ...
        ///      -H "Authorization: Bearer $TOGETHER_API_KEY"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.FineTuneModelLimits>> GetFineTunesModelsLimitsAsResponseAsync(
            string modelName,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.FineTuneModelLimits.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.FineTuneModelLimits>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.FineTuneModelLimits.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
