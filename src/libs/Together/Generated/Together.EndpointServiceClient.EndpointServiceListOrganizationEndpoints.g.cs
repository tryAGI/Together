...
namespace Together
{
    public partial class EndpointServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EndpointServiceListOrganizationEndpointsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EndpointServiceListOrganizationEndpointsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EndpointServiceListOrganizationEndpointsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EndpointServiceListOrganizationEndpointsSecurityRequirement0,
            };
        partial void PrepareEndpointServiceListOrganizationEndpointsArguments(
            ...
            ref string? orderBy,
            ref string? filter);
        partial void PrepareEndpointServiceListOrganizationEndpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? orderBy,
            string? filter);
        partial void ProcessEndpointServiceListOrganizationEndpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEndpointServiceListOrganizationEndpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeListEndpointsResponse> EndpointServiceListOrganizationEndpointsAsync(
            string organizationId,
            int? limit = default,
        ...
        {
            var __response = await EndpointServiceListOrganizationEndpointsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeListEndpointsResponse>> EndpointServiceListOrganizationEndpointsAsResponseAsync(
            string organizationId,
            int? limit = default,
            string? after = default,
            string? orderBy = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEndpointServiceListOrganizationEndpointsArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EndpointServiceListOrganizationEndpointsSecurityRequirements,
                operationName: "EndpointServiceListOrganizationEndpointsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EndpointServiceListOrganizationEndpointsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEndpointServiceListOrganizationEndpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EndpointServiceListOrganizationEndpoints",
                                methodName: "EndpointServiceListOrganizationEndpointsAsync",
                                pathTemplate: "$\"/organizations/{organizationId}/endpoints\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEndpointServiceListOrganizationEndpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEndpointServiceListOrganizationEndpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeListEndpointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeListEndpointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeListEndpointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
