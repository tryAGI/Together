...
namespace Together
{
    ...
    {
        partial void PrepareCreateBatchesByIdCancelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareCreateBatchesByIdCancelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessCreateBatchesByIdCancelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateBatchesByIdCancelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.BatchJob> CreateBatchesByIdCancelAsync(
            string id,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateBatchesByIdCancelArguments(
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_400 = await global::Together.BatchErrorResponse.FromJsonStreamAsync(__contentStream_400, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_403 = await global::Together.BatchErrorResponse.FromJsonStreamAsync(__contentStream_403, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_404 = await global::Together.BatchErrorResponse.FromJsonStreamAsync(__contentStream_404, JsonSerializerContext).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
