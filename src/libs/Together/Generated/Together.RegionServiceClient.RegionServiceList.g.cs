...
namespace Together
{
    public partial class RegionServiceClient
    {

        private static readonly global::Together.AutoSDKServer[] s_RegionServiceListServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RegionServiceListSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RegionServiceListSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RegionServiceListSecurityRequirement0,
            };
        partial void PrepareRegionServiceListArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareRegionServiceListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessRegionServiceListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRegionServiceListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// print(regions)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.RegionListResponse> RegionServiceListAsync(
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RegionServiceListAsResponseAsync(
        ...
        /// print(regions)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RegionListResponse>> RegionServiceListAsResponseAsync(
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRegionServiceListArguments(
                httpClient: HttpClient);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_RegionServiceListSecurityRequirements,
                operationName: "RegionServiceListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_RegionServiceListServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RegionServiceList",
                                methodName: "RegionServiceListAsync",
                                pathTemplate: "\"/compute/regions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRegionServiceListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRegionServiceListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RegionListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RegionListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RegionListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
