...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EstimateModelResourcesCostServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EstimateModelResourcesCostSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EstimateModelResourcesCostSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EstimateModelResourcesCostSecurityRequirement0,
            };
        partial void PrepareEstimateModelResourcesCostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Together.RlCreateModelResourcesRequest request);
        partial void PrepareEstimateModelResourcesCostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Together.RlCreateModelResourcesRequest request);
        partial void ProcessEstimateModelResourcesCostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEstimateModelResourcesCostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlModelResourcesEstimateCostResponse> EstimateModelResourcesCostAsync(

            global::Together.RlCreateModelResourcesRequest request,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EstimateModelResourcesCostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlModelResourcesEstimateCostResponse>> EstimateModelResourcesCostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEstimateModelResourcesCostArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EstimateModelResourcesCostSecurityRequirements,
                operationName: "EstimateModelResourcesCostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EstimateModelResourcesCostServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEstimateModelResourcesCostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EstimateModelResourcesCostAsync",
                                pathTemplate: "\"/rl/model-resources/estimate-cost\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEstimateModelResourcesCostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEstimateModelResourcesCostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RlModelResourcesEstimateCostResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RlModelResourcesEstimateCostResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RlModelResourcesEstimateCostResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlModelResourcesEstimateCostResponse> EstimateModelResourcesCostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.RlCreateModelResourcesRequest
            {
                BaseModel = baseModel,
            ...
            return await EstimateModelResourcesCostAsync(
                request: __request,
                requestOptions: requestOptions,
