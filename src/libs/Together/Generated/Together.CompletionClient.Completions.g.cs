...
namespace Together
{
    public partial class CompletionClient
    {
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_CompletionsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
        ...
        /// print(response.choices[0].text)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.CompletionResponse>> CompletionsAsResponseAsync(
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Together.AutoSDKHttpResponse<global::Together.CompletionResponse>(
                                        statusCode: __response.StatusCode,
