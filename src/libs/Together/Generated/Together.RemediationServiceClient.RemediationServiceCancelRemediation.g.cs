...
namespace Together
{
    public partial class RemediationServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RemediationServiceCancelRemediationServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RemediationServiceCancelRemediationSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RemediationServiceCancelRemediationSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RemediationServiceCancelRemediationSecurityRequirement0,
            };
        partial void PrepareRemediationServiceCancelRemediationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId,
            ref string instanceId,
            ref string remediationId);
        partial void PrepareRemediationServiceCancelRemediationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string clusterId,
            string instanceId,
            string remediationId);
        partial void ProcessRemediationServiceCancelRemediationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemediationServiceCancelRemediationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.Remediation> RemediationServiceCancelRemediationAsync(
            string clusterId,
            string instanceId,
            string remediationId,
        ...
        {
            var __response = await RemediationServiceCancelRemediationAsResponseAsync(
                clusterId: clusterId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.Remediation>> RemediationServiceCancelRemediationAsResponseAsync(
            string clusterId,
            string instanceId,
            string remediationId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRemediationServiceCancelRemediationArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemediationServiceCancelRemediationSecurityRequirements,
                operationName: "RemediationServiceCancelRemediationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/compute/clusters/{clusterId}/instances/{instanceId}/remediations/{remediationId}/cancel",
                                baseUri: ResolveBaseUri(
                                servers: s_RemediationServiceCancelRemediationServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RemediationServiceCancelRemediation",
                                methodName: "RemediationServiceCancelRemediationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemediationServiceCancelRemediationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemediationServiceCancelRemediationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
