...
namespace Together
{
    public partial class FineTuningClient
    {
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetFineTunesByIdMetricsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetFineTunesByIdMetricsSecurityRequirement0,
            };
        ...
        partial void ProcessGetFineTunesByIdMetricsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetFineTunesByIdMetricsAsResponseAsync(
                id: id,
                globalStepFrom: globalStepFrom,
                globalStepTo: globalStepTo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFineTunesByIdMetricsArguments(
                httpClient: HttpClient,
                id: ref id,
                globalStepFrom: ref globalStepFrom,
                globalStepTo: ref globalStepTo,
                loggedAtFrom: ref loggedAtFrom,
                loggedAtTo: ref loggedAtTo,
                resolution: ref resolution);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetFineTunesByIdMetricsSecurityRequirements,
                operationName: "GetFineTunesByIdMetricsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("logged_at_from", loggedAtFrom?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("logged_at_to", loggedAtTo?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("resolution", resolution?.ToString())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFineTunesByIdMetricsRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getFineTunesByIdMetrics",
                                methodName: "GetFineTunesByIdMetricsAsync",
                                pathTemplate: "$\"/fine-tunes/{id}/metrics\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFineTunesByIdMetricsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.GetFineTunesMetricsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.GetFineTunesMetricsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.GetFineTunesMetricsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
