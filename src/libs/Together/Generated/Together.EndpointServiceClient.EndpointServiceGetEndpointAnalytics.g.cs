...
namespace Together
{
    public partial class EndpointServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EndpointServiceGetEndpointAnalyticsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EndpointServiceGetEndpointAnalyticsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EndpointServiceGetEndpointAnalyticsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EndpointServiceGetEndpointAnalyticsSecurityRequirement0,
            };
        partial void PrepareEndpointServiceGetEndpointAnalyticsArguments(
            ...
            ref bool? includeTimeSeries,
            ref string? granularity);
        partial void PrepareEndpointServiceGetEndpointAnalyticsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? granularity);
        partial void ProcessEndpointServiceGetEndpointAnalyticsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEndpointServiceGetEndpointAnalyticsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeAnalyticsData> EndpointServiceGetEndpointAnalyticsAsync(
            string projectId,
            string id,
        ...
        {
            var __response = await EndpointServiceGetEndpointAnalyticsAsResponseAsync(
                projectId: projectId,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeAnalyticsData>> EndpointServiceGetEndpointAnalyticsAsResponseAsync(
            string projectId,
            string id,
            string? deploymentId = default,
            global::System.DateTime? startTime = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEndpointServiceGetEndpointAnalyticsArguments(
                ...
                endTime: ref endTime,
                includeTimeSeries: ref includeTimeSeries,
                granularity: ref granularity);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_EndpointServiceGetEndpointAnalyticsSecurityRequirements,
                operationName: "EndpointServiceGetEndpointAnalyticsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EndpointServiceGetEndpointAnalyticsServers,
                                defaultBaseUrl: "https://api.together.ai/v2"));
                            __pathBuilder
                                .AddOptionalParameter("deploymentId", deploymentId)
                                .AddOptionalParameter("startTime", startTime?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("endTime", endTime?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("includeTimeSeries", includeTimeSeries?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("granularity", granularity)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEndpointServiceGetEndpointAnalyticsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EndpointServiceGetEndpointAnalytics",
                                methodName: "EndpointServiceGetEndpointAnalyticsAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{id}/analytics\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEndpointServiceGetEndpointAnalyticsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEndpointServiceGetEndpointAnalyticsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeAnalyticsData.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeAnalyticsData>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeAnalyticsData.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
