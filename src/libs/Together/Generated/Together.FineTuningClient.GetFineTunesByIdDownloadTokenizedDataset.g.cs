...
namespace Together
{
    public partial class FineTuningClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetFineTunesByIdDownloadTokenizedDatasetServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetFineTunesByIdDownloadTokenizedDatasetSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetFineTunesByIdDownloadTokenizedDatasetSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetFineTunesByIdDownloadTokenizedDatasetSecurityRequirement0,
            };
        partial void PrepareGetFineTunesByIdDownloadTokenizedDatasetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetFineTunesByIdDownloadTokenizedDatasetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetFineTunesByIdDownloadTokenizedDatasetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFineTunesByIdDownloadTokenizedDatasetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.FineTuneTokenizedDatasetRetrieveResponse> GetFineTunesByIdDownloadTokenizedDatasetAsync(
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetFineTunesByIdDownloadTokenizedDatasetAsResponseAsync(
                id: id,
        ...
        /// print(tokenized_dataset.size)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.FineTuneTokenizedDatasetRetrieveResponse>> GetFineTunesByIdDownloadTokenizedDatasetAsResponseAsync(
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFineTunesByIdDownloadTokenizedDatasetArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFineTunesByIdDownloadTokenizedDatasetSecurityRequirements,
                operationName: "GetFineTunesByIdDownloadTokenizedDatasetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_GetFineTunesByIdDownloadTokenizedDatasetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFineTunesByIdDownloadTokenizedDatasetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getFineTunesByIdDownloadTokenizedDataset",
                                methodName: "GetFineTunesByIdDownloadTokenizedDatasetAsync",
                                pathTemplate: "$\"/fine-tunes/{id}/download-tokenized-dataset\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFineTunesByIdDownloadTokenizedDatasetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Fine-tune job or tokenized dataset not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFineTunesByIdDownloadTokenizedDatasetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.FineTuneTokenizedDatasetRetrieveResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.FineTuneTokenizedDatasetRetrieveResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.FineTuneTokenizedDatasetRetrieveResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
