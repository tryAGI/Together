...
namespace Together
{
    ...
    public sealed partial class VolumesSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static VolumesSourceGenerationContext Default { get; } = new(DefaultOptions);

        private VolumesSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
