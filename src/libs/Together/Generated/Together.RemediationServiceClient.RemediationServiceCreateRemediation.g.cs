...
namespace Together
{
    public partial class RemediationServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RemediationServiceCreateRemediationServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RemediationServiceCreateRemediationSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RemediationServiceCreateRemediationSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RemediationServiceCreateRemediationSecurityRequirement0,
            };
        partial void PrepareRemediationServiceCreateRemediationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId,
            ref string instanceId,
            ref string? remediationId,
            global::Together.Remediation request);
        partial void PrepareRemediationServiceCreateRemediationRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Together.Remediation request);
        partial void ProcessRemediationServiceCreateRemediationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemediationServiceCreateRemediationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.Remediation> RemediationServiceCreateRemediationAsync(
            string clusterId,
            string instanceId,
        ...
        {
            var __response = await RemediationServiceCreateRemediationAsResponseAsync(
                clusterId: clusterId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.Remediation>> RemediationServiceCreateRemediationAsResponseAsync(
            string clusterId,
            string instanceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemediationServiceCreateRemediationArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemediationServiceCreateRemediationSecurityRequirements,
                operationName: "RemediationServiceCreateRemediationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_RemediationServiceCreateRemediationServers,
                                defaultBaseUrl: "https://api.together.ai/v1"));
                            __pathBuilder
                                .AddOptionalParameter("remediation_id", remediationId)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemediationServiceCreateRemediationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RemediationServiceCreateRemediation",
                                methodName: "RemediationServiceCreateRemediationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemediationServiceCreateRemediationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemediationServiceCreateRemediationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.Remediation> RemediationServiceCreateRemediationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.Remediation
            {
                Mode = mode,
                Reason = reason,
            };

            return await RemediationServiceCreateRemediationAsync(
                clusterId: clusterId,
                instanceId: instanceId,
                remediationId: remediationId,
                request: __request,
