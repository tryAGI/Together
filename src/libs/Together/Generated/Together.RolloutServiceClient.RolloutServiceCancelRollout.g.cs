...
namespace Together
{
    public partial class RolloutServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RolloutServiceCancelRolloutServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RolloutServiceCancelRolloutSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RolloutServiceCancelRolloutSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RolloutServiceCancelRolloutSecurityRequirement0,
            };
        partial void PrepareRolloutServiceCancelRolloutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string id,
            global::Together.DeCancelRolloutRequest request);
        partial void PrepareRolloutServiceCancelRolloutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string id,
            global::Together.DeCancelRolloutRequest request);
        partial void ProcessRolloutServiceCancelRolloutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRolloutServiceCancelRolloutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServiceCancelRolloutAsync(
            string projectId,
            string endpointId,
            string id,
        ...
        {
            var __response = await RolloutServiceCancelRolloutAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRollout>> RolloutServiceCancelRolloutAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRolloutServiceCancelRolloutArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RolloutServiceCancelRolloutSecurityRequirements,
                operationName: "RolloutServiceCancelRolloutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/cancel",
                                baseUri: ResolveBaseUri(
                                servers: s_RolloutServiceCancelRolloutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRolloutServiceCancelRolloutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RolloutServiceCancelRollout",
                                methodName: "RolloutServiceCancelRolloutAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRolloutServiceCancelRolloutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRolloutServiceCancelRolloutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServiceCancelRolloutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeCancelRolloutRequest
            {
                Reason = reason,
                Etag = etag,
            ...
            return await RolloutServiceCancelRolloutAsync(
                projectId: projectId,
                endpointId: endpointId,
                id: id,
                request: __request,
