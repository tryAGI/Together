...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_DownloadCheckpointServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_DownloadCheckpointSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_DownloadCheckpointSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_DownloadCheckpointSecurityRequirement0,
            };
        partial void PrepareDownloadCheckpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref global::Together.RlCheckpointVariant variant);
        partial void PrepareDownloadCheckpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Together.RlCheckpointVariant variant);
        partial void ProcessDownloadCheckpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDownloadCheckpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlCheckpointDownloadResponse> DownloadCheckpointAsync(
            string id,
        ...
        {
            var __response = await DownloadCheckpointAsResponseAsync(
                id: id,
                variant: variant,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlCheckpointDownloadResponse>> DownloadCheckpointAsResponseAsync(
            string id,
            global::Together.RlCheckpointVariant variant = global::Together.RlCheckpointVariant.CheckpointVariantUnspecified,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadCheckpointArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadCheckpointSecurityRequirements,
                operationName: "DownloadCheckpointAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_DownloadCheckpointServers,
                                defaultBaseUrl: "https://api.together.ai/v1"));
                            __pathBuilder
                                .AddRequiredParameter("variant", variant.ToValueString())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadCheckpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DownloadCheckpointAsync",
                                pathTemplate: "$\"/rl/checkpoints/{id}/download\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadCheckpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDownloadCheckpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RlCheckpointDownloadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RlCheckpointDownloadResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RlCheckpointDownloadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
