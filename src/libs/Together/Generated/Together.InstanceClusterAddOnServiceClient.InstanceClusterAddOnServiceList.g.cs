...
namespace Together
{
    public partial class InstanceClusterAddOnServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_InstanceClusterAddOnServiceListServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_InstanceClusterAddOnServiceListSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_InstanceClusterAddOnServiceListSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_InstanceClusterAddOnServiceListSecurityRequirement0,
            };
        partial void PrepareInstanceClusterAddOnServiceListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId);
        partial void PrepareInstanceClusterAddOnServiceListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string clusterId);
        partial void ProcessInstanceClusterAddOnServiceListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInstanceClusterAddOnServiceListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.ClusterAddOnsListResponse> InstanceClusterAddOnServiceListAsync(
            string clusterId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await InstanceClusterAddOnServiceListAsResponseAsync(
                clusterId: clusterId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.ClusterAddOnsListResponse>> InstanceClusterAddOnServiceListAsResponseAsync(
            string clusterId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInstanceClusterAddOnServiceListArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InstanceClusterAddOnServiceListSecurityRequirements,
                operationName: "InstanceClusterAddOnServiceListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_InstanceClusterAddOnServiceListServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInstanceClusterAddOnServiceListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InstanceClusterAddOnServiceList",
                                methodName: "InstanceClusterAddOnServiceListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInstanceClusterAddOnServiceListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInstanceClusterAddOnServiceListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.ClusterAddOnsListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.ClusterAddOnsListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.ClusterAddOnsListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
