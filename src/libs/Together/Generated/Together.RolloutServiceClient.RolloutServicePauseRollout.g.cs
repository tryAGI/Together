...
namespace Together
{
    public partial class RolloutServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_RolloutServicePauseRolloutServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_RolloutServicePauseRolloutSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_RolloutServicePauseRolloutSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_RolloutServicePauseRolloutSecurityRequirement0,
            };
        partial void PrepareRolloutServicePauseRolloutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            ref string id,
            global::Together.DePauseRolloutRequest request);
        partial void PrepareRolloutServicePauseRolloutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string id,
            global::Together.DePauseRolloutRequest request);
        partial void ProcessRolloutServicePauseRolloutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRolloutServicePauseRolloutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServicePauseRolloutAsync(
            string projectId,
            string endpointId,
            string id,
        ...
        {
            var __response = await RolloutServicePauseRolloutAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeRollout>> RolloutServicePauseRolloutAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRolloutServicePauseRolloutArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RolloutServicePauseRolloutSecurityRequirements,
                operationName: "RolloutServicePauseRolloutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_RolloutServicePauseRolloutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRolloutServicePauseRolloutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RolloutServicePauseRollout",
                                methodName: "RolloutServicePauseRolloutAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/rollouts/{id}/pause\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRolloutServicePauseRolloutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRolloutServicePauseRolloutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeRollout> RolloutServicePauseRolloutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DePauseRolloutRequest
            {
                Etag = etag,
                Reason = reason,
            };

            return await RolloutServicePauseRolloutAsync(
                projectId: projectId,
                endpointId: endpointId,
                id: id,
                request: __request,
