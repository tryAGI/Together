...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetForwardBackwardOperationServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetForwardBackwardOperationSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetForwardBackwardOperationSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetForwardBackwardOperationSecurityRequirement0,
            };
        partial void PrepareGetForwardBackwardOperationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref string operationId);
        partial void PrepareGetForwardBackwardOperationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string operationId);
        partial void ProcessGetForwardBackwardOperationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetForwardBackwardOperationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlForwardBackwardOperation> GetForwardBackwardOperationAsync(
            string sessionId,
            string operationId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetForwardBackwardOperationAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlForwardBackwardOperation>> GetForwardBackwardOperationAsResponseAsync(
            string sessionId,
            string operationId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetForwardBackwardOperationArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetForwardBackwardOperationSecurityRequirements,
                operationName: "GetForwardBackwardOperationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/rl/training-sessions/{sessionId}/operations/forward-backward/{operationId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetForwardBackwardOperationServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetForwardBackwardOperationAsync",
                                pathTemplate: "$\"/rl/training-sessions/{sessionId}/operations/forward-backward/{operationId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetForwardBackwardOperationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetForwardBackwardOperationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RlForwardBackwardOperation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RlForwardBackwardOperation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RlForwardBackwardOperation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
