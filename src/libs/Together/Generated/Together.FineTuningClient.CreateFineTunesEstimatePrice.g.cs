...
namespace Together
{
    public partial class FineTuningClient
    {
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_CreateFineTunesEstimatePriceSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_CreateFineTunesEstimatePriceSecurityRequirement0,
            };
        ...
        {
            var __response = await CreateFineTunesEstimatePriceAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                operationName: "CreateFineTunesEstimatePriceAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createFineTunesEstimatePrice",
                                methodName: "CreateFineTunesEstimatePriceAsync",
                                pathTemplate: "\"/fine-tunes/estimate-price\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
