...
namespace Together
{
    public partial interface IEvaluationClient
    {
        ...
        /// print(response.results)
        /// </remarks>
        global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.GetEvaluationJobStatusAndResultsResponse>> GetEvaluationJobStatusAndResultsAsResponseAsync(
            string id,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
