...
namespace Together
{
    ...
    public sealed partial class RemediationServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static RemediationServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private RemediationServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
