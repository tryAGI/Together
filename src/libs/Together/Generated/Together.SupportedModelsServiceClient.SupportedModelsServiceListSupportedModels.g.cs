...
namespace Together
{
    public partial class SupportedModelsServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_SupportedModelsServiceListSupportedModelsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_SupportedModelsServiceListSupportedModelsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_SupportedModelsServiceListSupportedModelsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_SupportedModelsServiceListSupportedModelsSecurityRequirement0,
            };
        partial void PrepareSupportedModelsServiceListSupportedModelsArguments(
        ...
        partial void ProcessSupportedModelsServiceListSupportedModelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeListSupportedModelsResponse> SupportedModelsServiceListSupportedModelsAsync(
        ...
        {
            var __response = await SupportedModelsServiceListSupportedModelsAsResponseAsync(
                modality: modality,
                product: product,
                search: search,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeListSupportedModelsResponse>> SupportedModelsServiceListSupportedModelsAsResponseAsync(
            global::Together.SupportedModelsServiceListSupportedModelsModality? modality = default,
            global::Together.SupportedModelsServiceListSupportedModelsProduct? product = default,
            string? search = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSupportedModelsServiceListSupportedModelsArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SupportedModelsServiceListSupportedModelsSecurityRequirements,
                operationName: "SupportedModelsServiceListSupportedModelsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_SupportedModelsServiceListSupportedModelsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSupportedModelsServiceListSupportedModelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SupportedModelsServiceListSupportedModels",
                                methodName: "SupportedModelsServiceListSupportedModelsAsync",
                                pathTemplate: "\"/supported-models\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSupportedModelsServiceListSupportedModelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSupportedModelsServiceListSupportedModelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeListSupportedModelsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeListSupportedModelsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeListSupportedModelsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
