...
namespace Together
{
    ...
    /// Example: {"spec":{"sourceDeploymentId":"dep_source123","targetDeploymentId":"dep_target456","canary":{"steps":[{"traffic":25},{"traffic":50},{"traffic":100}],"stepInterval":"300s"},"metrics":[{"name":"router_latency","stat":"METRIC_STAT_TYPE_PERCENTILE","percentile":95,"thresholdCheck":{"value":30000,"operator":"THRESHOLD_OPERATOR_LT"},"window":"300s"}]},"sourceReplicas":4,"targetReplicas":1,"targetMinReplicas":1,"targetMaxReplicas":8,"warnings":[],"frozenPair":false}
    /// </summary>
