...
namespace Together
{
    public partial class EndpointServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EndpointServiceCreateEndpointServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EndpointServiceCreateEndpointSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EndpointServiceCreateEndpointSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EndpointServiceCreateEndpointSecurityRequirement0,
            };
        partial void PrepareEndpointServiceCreateEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Together.DeCreateEndpointRequest request);
        partial void PrepareEndpointServiceCreateEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Together.DeCreateEndpointRequest request);
        partial void ProcessEndpointServiceCreateEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEndpointServiceCreateEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeEndpoint> EndpointServiceCreateEndpointAsync(
            string projectId,
        ...
        {
            var __response = await EndpointServiceCreateEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeEndpoint>> EndpointServiceCreateEndpointAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEndpointServiceCreateEndpointArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EndpointServiceCreateEndpointSecurityRequirements,
                operationName: "EndpointServiceCreateEndpointAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EndpointServiceCreateEndpointServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEndpointServiceCreateEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EndpointServiceCreateEndpoint",
                                methodName: "EndpointServiceCreateEndpointAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEndpointServiceCreateEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEndpointServiceCreateEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeEndpoint.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeEndpoint>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeEndpoint.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeEndpoint> EndpointServiceCreateEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeCreateEndpointRequest
            {
                Name = name,
                Visibility = visibility,
            };

            return await EndpointServiceCreateEndpointAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
