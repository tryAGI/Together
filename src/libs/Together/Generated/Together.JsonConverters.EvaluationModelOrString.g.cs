...
namespace Together.JsonConverters
{
    ...
    public class EvaluationModelOrStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Together.EvaluationModelOrString>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        evaluationModelOrStringVariant1 = global::System.Text.Json.JsonSerializer.Deserialize<string>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        request = global::System.Text.Json.JsonSerializer.Deserialize<global::Together.EvaluationModelRequest>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.EvaluationModelOrStringVariant1, typeof(string), options);
            }
            else if (value.IsRequest)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Request, typeof(global::Together.EvaluationModelRequest), options);
            }
        }
    }
}