...
namespace Together
{
    public partial class EndpointServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_EndpointServiceListPublicEndpointsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_EndpointServiceListPublicEndpointsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_EndpointServiceListPublicEndpointsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_EndpointServiceListPublicEndpointsSecurityRequirement0,
            };
        partial void PrepareEndpointServiceListPublicEndpointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? after,
            ref string? orderBy,
            ref string? filter);
        partial void PrepareEndpointServiceListPublicEndpointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? orderBy,
            string? filter);
        partial void ProcessEndpointServiceListPublicEndpointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEndpointServiceListPublicEndpointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List public endpoints<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeListPublicEndpointsResponse> EndpointServiceListPublicEndpointsAsync(
            int? limit = default,
        ...
        {
            var __response = await EndpointServiceListPublicEndpointsAsResponseAsync(
                limit: limit,
                after: after,
                orderBy: orderBy,
                filter: filter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeListPublicEndpointsResponse>> EndpointServiceListPublicEndpointsAsResponseAsync(
            int? limit = default,
            string? after = default,
            string? orderBy = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEndpointServiceListPublicEndpointsArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EndpointServiceListPublicEndpointsSecurityRequirements,
                operationName: "EndpointServiceListPublicEndpointsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_EndpointServiceListPublicEndpointsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEndpointServiceListPublicEndpointsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EndpointServiceListPublicEndpoints",
                                methodName: "EndpointServiceListPublicEndpointsAsync",
                                pathTemplate: "\"/public/endpoints\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEndpointServiceListPublicEndpointsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEndpointServiceListPublicEndpointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeListPublicEndpointsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeListPublicEndpointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeListPublicEndpointsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
