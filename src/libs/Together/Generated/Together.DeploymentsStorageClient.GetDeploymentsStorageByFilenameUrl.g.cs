...
namespace Together
{
    public partial class DeploymentsStorageClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetDeploymentsStorageByFilenameUrlServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetDeploymentsStorageByFilenameUrlSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetDeploymentsStorageByFilenameUrlSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetDeploymentsStorageByFilenameUrlSecurityRequirement0,
            };
        partial void PrepareGetDeploymentsStorageByFilenameUrlArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string filename);
        partial void PrepareGetDeploymentsStorageByFilenameUrlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string filename);
        partial void ProcessGetDeploymentsStorageByFilenameUrlResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDeploymentsStorageByFilenameUrlResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.SignedURLResponse> GetDeploymentsStorageByFilenameUrlAsync(
            string filename,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetDeploymentsStorageByFilenameUrlAsResponseAsync(
                filename: filename,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.SignedURLResponse>> GetDeploymentsStorageByFilenameUrlAsResponseAsync(
            string filename,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDeploymentsStorageByFilenameUrlArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDeploymentsStorageByFilenameUrlSecurityRequirements,
                operationName: "GetDeploymentsStorageByFilenameUrlAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_GetDeploymentsStorageByFilenameUrlServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDeploymentsStorageByFilenameUrlRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDeploymentsStorageByFilenameUrl",
                                methodName: "GetDeploymentsStorageByFilenameUrlAsync",
                                pathTemplate: "$\"/deployments/storage/{filename}/url\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDeploymentsStorageByFilenameUrlResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Together.ApiException<global::System.Collections.Generic.Dictionary<string, string>>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDeploymentsStorageByFilenameUrlResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.SignedURLResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.SignedURLResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.SignedURLResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
