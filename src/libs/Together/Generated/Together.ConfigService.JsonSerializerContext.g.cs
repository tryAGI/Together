...
namespace Together
{
    ...
    public sealed partial class ConfigServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ConfigServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ConfigServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
