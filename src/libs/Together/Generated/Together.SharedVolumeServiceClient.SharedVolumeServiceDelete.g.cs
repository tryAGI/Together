...
namespace Together
{
    public partial class SharedVolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_SharedVolumeServiceDeleteServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_SharedVolumeServiceDeleteSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_SharedVolumeServiceDeleteSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_SharedVolumeServiceDeleteSecurityRequirement0,
            };
        partial void PrepareSharedVolumeServiceDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string volumeId);
        partial void PrepareSharedVolumeServiceDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string volumeId);
        partial void ProcessSharedVolumeServiceDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSharedVolumeServiceDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Delete a shared volume by ID<br/>
        ...
        {
            var __response = await SharedVolumeServiceDeleteAsResponseAsync(
                volumeId: volumeId,
        ...
        /// print(volume)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.GPUClustersSharedVolumeDeleteResponse>> SharedVolumeServiceDeleteAsResponseAsync(
            string volumeId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSharedVolumeServiceDeleteArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SharedVolumeServiceDeleteSecurityRequirements,
                operationName: "SharedVolumeServiceDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/compute/clusters/storage/volumes/{volumeId}",
                                baseUri: ResolveBaseUri(
                                servers: s_SharedVolumeServiceDeleteServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSharedVolumeServiceDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SharedVolumeServiceDelete",
                                methodName: "SharedVolumeServiceDeleteAsync",
                                pathTemplate: "$\"/compute/clusters/storage/volumes/{volumeId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSharedVolumeServiceDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSharedVolumeServiceDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.GPUClustersSharedVolumeDeleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.GPUClustersSharedVolumeDeleteResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.GPUClustersSharedVolumeDeleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
