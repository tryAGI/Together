...
namespace Together
{
    public partial class VolumeServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_VolumeServiceCreateModelServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_VolumeServiceCreateModelSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_VolumeServiceCreateModelSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_VolumeServiceCreateModelSecurityRequirement0,
            };
        partial void PrepareVolumeServiceCreateModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Together.DeCreateModelRequest request);
        partial void PrepareVolumeServiceCreateModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Together.DeCreateModelRequest request);
        partial void ProcessVolumeServiceCreateModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVolumeServiceCreateModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeModel> VolumeServiceCreateModelAsync(
            string projectId,
        ...
        {
            var __response = await VolumeServiceCreateModelAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeModel>> VolumeServiceCreateModelAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareVolumeServiceCreateModelArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VolumeServiceCreateModelSecurityRequirements,
                operationName: "VolumeServiceCreateModelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_VolumeServiceCreateModelServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVolumeServiceCreateModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VolumeServiceCreateModel",
                                methodName: "VolumeServiceCreateModelAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVolumeServiceCreateModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVolumeServiceCreateModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeModel> VolumeServiceCreateModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeCreateModelRequest
            {
                Name = name,
                Type = type,
            ...
            return await VolumeServiceCreateModelAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
