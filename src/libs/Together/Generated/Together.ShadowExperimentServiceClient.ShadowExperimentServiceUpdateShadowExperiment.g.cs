...
namespace Together
{
    public partial class ShadowExperimentServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_ShadowExperimentServiceUpdateShadowExperimentServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_ShadowExperimentServiceUpdateShadowExperimentSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_ShadowExperimentServiceUpdateShadowExperimentSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_ShadowExperimentServiceUpdateShadowExperimentSecurityRequirement0,
            };
        partial void PrepareShadowExperimentServiceUpdateShadowExperimentArguments(
        ...
        partial void PrepareShadowExperimentServiceUpdateShadowExperimentRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string updateMask,
            global::Together.DeUpdateShadowExperimentRequest request);
        partial void ProcessShadowExperimentServiceUpdateShadowExperimentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessShadowExperimentServiceUpdateShadowExperimentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeShadowExperiment> ShadowExperimentServiceUpdateShadowExperimentAsync(
            string projectId,
            string endpointId,
            string id,
            string updateMask,
        ...
        {
            var __response = await ShadowExperimentServiceUpdateShadowExperimentAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeShadowExperiment>> ShadowExperimentServiceUpdateShadowExperimentAsResponseAsync(
            string projectId,
            string endpointId,
            string id,
            string updateMask,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareShadowExperimentServiceUpdateShadowExperimentArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ShadowExperimentServiceUpdateShadowExperimentSecurityRequirements,
                operationName: "ShadowExperimentServiceUpdateShadowExperimentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_ShadowExperimentServiceUpdateShadowExperimentServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareShadowExperimentServiceUpdateShadowExperimentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ShadowExperimentServiceUpdateShadowExperiment",
                                methodName: "ShadowExperimentServiceUpdateShadowExperimentAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}/shadowExperiments/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessShadowExperimentServiceUpdateShadowExperimentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessShadowExperimentServiceUpdateShadowExperimentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeShadowExperiment.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeShadowExperiment>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeShadowExperiment.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeShadowExperiment> ShadowExperimentServiceUpdateShadowExperimentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.DeUpdateShadowExperimentRequest
            {
            ...
            return await ShadowExperimentServiceUpdateShadowExperimentAsync(
                projectId: projectId,
                endpointId: endpointId,
                id: id,
                updateMask: updateMask,
