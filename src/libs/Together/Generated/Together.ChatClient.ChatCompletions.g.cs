            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::Together.ErrorData.FromJsonStreamAsync(__contentStream_503, JsonSerializerContext).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                var __responseValue = await global::Together.ChatCompletionResponse.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
