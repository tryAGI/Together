...
namespace Together
{
    public partial class InstanceClusterAddOnServiceClient
    {
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_InstanceClusterAddOnServiceUpdateSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_InstanceClusterAddOnServiceUpdateSecurityRequirement0,
            };
        partial void PrepareInstanceClusterAddOnServiceUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId,
            ref string addonId,
            global::Together.ClusterAddOnUpdateRequest request);
        partial void PrepareInstanceClusterAddOnServiceUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string clusterId,
            string addonId,
            global::Together.ClusterAddOnUpdateRequest request);
        partial void ProcessInstanceClusterAddOnServiceUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInstanceClusterAddOnServiceUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.AddOnInfo> InstanceClusterAddOnServiceUpdateAsync(
            string clusterId,
            string addonId,
        ...
        {
            var __response = await InstanceClusterAddOnServiceUpdateAsResponseAsync(
                clusterId: clusterId,
                addonId: addonId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.AddOnInfo>> InstanceClusterAddOnServiceUpdateAsResponseAsync(
            string clusterId,
            string addonId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInstanceClusterAddOnServiceUpdateArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InstanceClusterAddOnServiceUpdateSecurityRequirements,
                operationName: "InstanceClusterAddOnServiceUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInstanceClusterAddOnServiceUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InstanceClusterAddOnServiceUpdate",
                                methodName: "InstanceClusterAddOnServiceUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInstanceClusterAddOnServiceUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInstanceClusterAddOnServiceUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.AddOnInfo> InstanceClusterAddOnServiceUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.ClusterAddOnUpdateRequest
            {
                Config = config,
            };

            return await InstanceClusterAddOnServiceUpdateAsync(
                clusterId: clusterId,
                addonId: addonId,
                request: __request,
                requestOptions: requestOptions,
