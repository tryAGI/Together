...
namespace Together
{
    public partial class GPUClusterServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GPUClusterServiceGetServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GPUClusterServiceGetSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GPUClusterServiceGetSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GPUClusterServiceGetSecurityRequirement0,
            };
        partial void PrepareGPUClusterServiceGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string clusterId);
        partial void PrepareGPUClusterServiceGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string clusterId);
        partial void ProcessGPUClusterServiceGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGPUClusterServiceGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// print(cluster)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.GPUClusterInfo> GPUClusterServiceGetAsync(
            string clusterId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GPUClusterServiceGetAsResponseAsync(
                clusterId: clusterId,
        ...
        /// print(cluster)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.GPUClusterInfo>> GPUClusterServiceGetAsResponseAsync(
            string clusterId,
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGPUClusterServiceGetArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GPUClusterServiceGetSecurityRequirements,
                operationName: "GPUClusterServiceGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_GPUClusterServiceGetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGPUClusterServiceGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GPUClusterServiceGet",
                                methodName: "GPUClusterServiceGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGPUClusterServiceGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGPUClusterServiceGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
