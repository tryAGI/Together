...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_CustomForwardBackwardServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_CustomForwardBackwardSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_CustomForwardBackwardSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_CustomForwardBackwardSecurityRequirement0,
            };
        partial void PrepareCustomForwardBackwardArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::Together.RlCustomForwardBackwardBody request);
        partial void PrepareCustomForwardBackwardRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::Together.RlCustomForwardBackwardBody request);
        partial void ProcessCustomForwardBackwardResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCustomForwardBackwardResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlCustomForwardBackwardOperation> CustomForwardBackwardAsync(
            string sessionId,
        ...
        {
            var __response = await CustomForwardBackwardAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlCustomForwardBackwardOperation>> CustomForwardBackwardAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCustomForwardBackwardArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CustomForwardBackwardSecurityRequirements,
                operationName: "CustomForwardBackwardAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/rl/training-sessions/{sessionId}/operations/custom-forward-backward",
                                baseUri: ResolveBaseUri(
                                servers: s_CustomForwardBackwardServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCustomForwardBackwardRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CustomForwardBackwardAsync",
                                pathTemplate: "$\"/rl/training-sessions/{sessionId}/operations/custom-forward-backward\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCustomForwardBackwardResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCustomForwardBackwardResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlCustomForwardBackwardOperation> CustomForwardBackwardAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.RlCustomForwardBackwardBody
            {
                Samples = samples,
                Gradients = gradients,
            };

            return await CustomForwardBackwardAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
