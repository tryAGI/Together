...
namespace Together
{
    ...
    public sealed partial class InstanceClusterAddOnServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static InstanceClusterAddOnServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private InstanceClusterAddOnServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
