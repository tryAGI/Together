...
namespace Together
{
    public partial class DeploymentsVolumesClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_GetDeploymentsStorageVolumesServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_GetDeploymentsStorageVolumesSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_GetDeploymentsStorageVolumesSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_GetDeploymentsStorageVolumesSecurityRequirement0,
            };
        partial void PrepareGetDeploymentsStorageVolumesArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetDeploymentsStorageVolumesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetDeploymentsStorageVolumesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDeploymentsStorageVolumesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetDeploymentsStorageVolumesAsResponseAsync(
        ...
        /// print(volumes)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.ListVolumesResponse>> GetDeploymentsStorageVolumesAsResponseAsync(
            global::Together.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDeploymentsStorageVolumesArguments(
                httpClient: HttpClient);


            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetDeploymentsStorageVolumesSecurityRequirements,
                operationName: "GetDeploymentsStorageVolumesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_GetDeploymentsStorageVolumesServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDeploymentsStorageVolumes",
                                methodName: "GetDeploymentsStorageVolumesAsync",
                                pathTemplate: "\"/deployments/storage/volumes\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDeploymentsStorageVolumesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDeploymentsStorageVolumesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.ListVolumesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.ListVolumesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.ListVolumesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
