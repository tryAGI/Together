...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_WeightsSyncServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_WeightsSyncSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_WeightsSyncSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_WeightsSyncSecurityRequirement0,
            };
        partial void PrepareWeightsSyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::Together.RlWeightsSyncBody request);
        partial void PrepareWeightsSyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::Together.RlWeightsSyncBody request);
        partial void ProcessWeightsSyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWeightsSyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlWeightsSyncOperation> WeightsSyncAsync(
            string sessionId,
        ...
        {
            var __response = await WeightsSyncAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.RlWeightsSyncOperation>> WeightsSyncAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WeightsSyncSecurityRequirements,
                operationName: "WeightsSyncAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                path: $"/rl/training-sessions/{sessionId}/operations/weights-sync",
                                baseUri: ResolveBaseUri(
                                servers: s_WeightsSyncServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "WeightsSyncAsync",
                                pathTemplate: "$\"/rl/training-sessions/{sessionId}/operations/weights-sync\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWeightsSyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.RlWeightsSyncOperation> WeightsSyncAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Together.RlWeightsSyncBody
            {
                WeightSyncType = weightSyncType,
            };

            return await WeightsSyncAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
