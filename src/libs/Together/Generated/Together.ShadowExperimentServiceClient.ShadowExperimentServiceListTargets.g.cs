...
namespace Together
{
    public partial class ShadowExperimentServiceClient
    {
        ...
        private static readonly global::Together.AutoSDKServer[] s_ShadowExperimentServiceListTargetsServers = new global::Together.AutoSDKServer[]
        ...
        private static readonly global::Together.EndPointSecurityRequirement s_ShadowExperimentServiceListTargetsSecurityRequirement0 =
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_ShadowExperimentServiceListTargetsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_ShadowExperimentServiceListTargetsSecurityRequirement0,
            };
        partial void PrepareShadowExperimentServiceListTargetsArguments(
            ...
            ref int? limit,
            ref string? after);
        partial void PrepareShadowExperimentServiceListTargetsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? after);
        partial void ProcessShadowExperimentServiceListTargetsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessShadowExperimentServiceListTargetsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Together.DeListShadowExperimentTargetsResponse> ShadowExperimentServiceListTargetsAsync(
            string projectId,
            string endpointId,
            string experimentId,
            int? limit = default,
        ...
        {
            var __response = await ShadowExperimentServiceListTargetsAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Together.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Together.AutoSDKHttpResponse<global::Together.DeListShadowExperimentTargetsResponse>> ShadowExperimentServiceListTargetsAsResponseAsync(
            string projectId,
            string endpointId,
            string experimentId,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareShadowExperimentServiceListTargetsArguments(
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ShadowExperimentServiceListTargetsSecurityRequirements,
                operationName: "ShadowExperimentServiceListTargetsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Together.PathBuilder(
                                ...
                                servers: s_ShadowExperimentServiceListTargetsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareShadowExperimentServiceListTargetsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ShadowExperimentServiceListTargets",
                                methodName: "ShadowExperimentServiceListTargetsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessShadowExperimentServiceListTargetsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessShadowExperimentServiceListTargetsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.DeListShadowExperimentTargetsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.DeListShadowExperimentTargetsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.DeListShadowExperimentTargetsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
