...
namespace Together
{
    ...
    public sealed partial class InstanceTypeServiceSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static InstanceTypeServiceSourceGenerationContext Default { get; } = new(DefaultOptions);

        private InstanceTypeServiceSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
