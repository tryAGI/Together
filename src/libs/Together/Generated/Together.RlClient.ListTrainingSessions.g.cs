...
namespace Together
{
    public partial class RlClient
    {
        ...
        private static readonly global::Together.EndPointSecurityRequirement[] s_ListTrainingSessionsSecurityRequirements =
            new global::Together.EndPointSecurityRequirement[]
            {                s_ListTrainingSessionsSecurityRequirement0,
            };
        ...
        {
            var __response = await ListTrainingSessionsAsResponseAsync(
                status: status,
                limit: limit,
                after: after,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Together.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListTrainingSessionsSecurityRequirements,
                operationName: "ListTrainingSessionsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Together.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListTrainingSessionsAsync",
                    ...
                    await global::Together.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Together.RlTrainingSessionsListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Together.AutoSDKHttpResponse<global::Together.RlTrainingSessionsListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Together.RlTrainingSessionsListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
