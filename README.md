...
## Features 🔥
- Fully generated C# SDK based on the [official Together OpenAPI specification](https://docs.together.ai/openapi.yaml) using [OpenApiGenerator](https://github.com/HavenDV/OpenApiGenerator)
